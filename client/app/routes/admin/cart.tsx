...
export default function Cart() {
  ...
  const [ownerType, setOwnerType] = useState<"all" | "user" | "anonymous">("all");
    ...
    <div className="sm:ml-80 min-h-screen bg-gray-50 p-6 text-black">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 mb-8">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-4xl font-bold text-gray-900 mb-2">Gestion des Paniers</h1>
          ...
          <div className="flex gap-4 w-full lg:w-auto">
            <div className="flex-1">
              ...
              <select
                id="owner"
                value={ownerType}
                onChange={e => setOwnerType(e.target.value as "all" | "user" | "anonymous")}
