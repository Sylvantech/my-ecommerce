                    ...
                    <div className="flex space-x-4 justify-center w-full overflow-x-auto pb-2">
                        {product.assets &&
                            product.assets.map((value, index) => (
                                <div
                                    key={value._id}
                                    className={`bg-white rounded-2xl shadow-lg w-20 h-20 flex-shrink-0 flex items-center justify-center border-2 transition-all duration-300 cursor-pointer hover:border-purple-400 hover:shadow-xl transform hover:scale-110 ${index === actualImage
                ...
                <div className="flex flex-col gap-8 w-full lg:w-1/2">
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-2">
                            <div className="flex">
                                <StarRating productId={product.id} className="text-yellow-400" />
                            </div>
