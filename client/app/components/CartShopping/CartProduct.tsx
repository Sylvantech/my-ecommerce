...
export default function CartProduct({
  name = "Chaussettes Arc-en-ciel Magique",
  color = "Red",
  size = "38-40",
  stock = 6,
  price = "20€",
            ...
            <div className="sm:flex sm:flex-col">
              ...
              <div className="sm:flex sm:flex-row gap-3 sm:items-center">
                <p className="text-gray-600 text-sm flex justify-center items-center gap-1">
                  Couleur:{" "}
                  <span className="border border-white w-6 h-6 bg-red-400 rounded-full shadow-lg"></span>{" "}
                  <span className="text-gray-900 ml-2">{color}</span>
                </p>
