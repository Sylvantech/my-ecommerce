export default function CategoryAdmin() {
  return (
    <div className="bg-white flex flex-col p-3 w-90 h-55 rounded-xl text-gray-700 gap-2 sm:w-full">
      <div className="flex items-center gap-2">
        ...
        <div className="flex flex-col w-full">
          <div className="flex justify-between">
            <h3 className="text-black">Chausettes Sport</h3>
      ...
      <p className="text-sm">Chaussettes classiques pour un usage quotidien</p>
