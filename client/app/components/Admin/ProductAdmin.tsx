...
export default function ProductAdmin({
  ...
  const filtered = useMemo(() => {
    ...
    return (products || []).filter((p: Product) => {
      ...
      const priceOkMin =
        min === undefined || (typeof p.price === "number" && p.price >= min);
      const priceOkMax =
        max === undefined || (typeof p.price === "number" && p.price <= max);
          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="bg-gray-100 text-gray-700">
                ...
                <th className="p-3 text-right text-sm font-semibold border-b border-gray-200">
                  Prix
                </th>
                  ...
                  <td className="p-3 border-b border-gray-100 text-gray-900">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex flex-col">
                        ...
                        {p.description ? (
                          <span className="text-xs text-gray-500 line-clamp-1 max-w-[360px]">
                            {p.description}
                          </span>
                        ) : null}
                      </div>
